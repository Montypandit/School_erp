    ...
    <nav className="bg-white shadow-lg border-b border-gray-200 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          {/* Profile/Logout Section - Fixed positioning */}
          <div className="flex items-center">
            <div className="relative" ref={dropdownRef}>
              ...
              >
                ...
                <span className="ml-3 text-gray-700 font-medium hidden sm:block max-w-[120px] truncate">
                  Coordinator
                </span>
                <svg
              ...
              {/* Desktop Dropdown Menu - Fixed z-index and positioning */}
              {isProfileOpen && (
                <div className="absolute right-0 mt-2 w-56 rounded-xl shadow-lg bg-white ring-1 ring-black ring-opacity-5 z-[100] border border-gray-100 transform origin-top-right">
                  <div className="py-2">
                    <div className="px-4 py-3 text-sm text-gray-700 border-b border-gray-100 bg-gray-50 rounded-t-xl">
                      <div className="font-semibold text-gray-900 truncate">John Coordinator</div>
                      <div className="text-gray-500 text-xs mt-1 truncate">coordinator@example.com</div>
                    </div>
                    <Link
                      to="/profile"
          ...
          <div className="md:hidden border-t border-gray-200 bg-gray-50">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <div className="px-3 py-2">
                <div className="text-sm font-medium text-gray-800 truncate">John Coordinator</div>
                <div className="text-xs text-gray-500 truncate">coordinator@example.com</div>
              </div>
              <Link
                to="/profile"
                className="text-gray-600 hover:bg-gray-100 hover:text-gray-900 block px-3 py-2 rounded-md text-base font-medium transition-colors duration-200"
