...
const PrincipalNavbar = () => {
  ...
  const [adminInfo, setAdminInfo] = useState({ name: 'Principal', email: 'principal@example.com' });
        ...
        <div className="md:hidden border-t border-gray-200 bg-gray-50">
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            <div className="px-3 py-2">
              <div className="text-sm font-medium text-gray-800">{adminInfo.name || 'Principal'}</div>
              <div className="text-xs text-gray-500">{adminInfo.email || 'principal@example.com'}</div>
            </div>
            <button
              onClick={handleLogout}
