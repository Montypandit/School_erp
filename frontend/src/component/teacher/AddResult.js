      ...
      {completeResult && (
        <div className="bg-white p-6 rounded shadow mb-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-2xl font-semibold bg-green-700 text-white">Complete Result Summary</h2>
          </div>
          ...
          {completeResult.subjectSummaries && completeResult.subjectSummaries.length > 0 ? (
            <div>
              <h3 className="text-lg   font-medium mb-3 text-green-700">Subject-wise Breakdown:</h3>
