...
const EmployeeLogin = () => {
  ...
  const removeUserAccess = async () => {
    ...
    try {
      const res = await fetch(`https://school-erp-1-exji.onrender.com/api/auth/delete/user/${email}`, {
        method: 'DELETE',
        headers: {
  ...
  useEffect(() => {
    const fetchEmployeeRole = async () => {
      ...
      try {
        const resp = await fetch(`https://school-erp-1-exji.onrender.com/api/employees/get/employee/email/${email}`, {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('https://school-erp-1-exji.onrender.com/api/auth/create/user', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
