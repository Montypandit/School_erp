...
router.post('/create/process/inquiry/form', authMiddleware, authorizeRoles('admin', 'coordinator'), async (req, res) => {
  try {
...
router.get('/get/all/inquiry/form-processes', authMiddleware, authorizeRoles('admin', 'coordinator'), async (req, res) => {
  try {
